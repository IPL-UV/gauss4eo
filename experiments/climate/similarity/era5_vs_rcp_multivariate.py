...
from src.models.multivariate import get_multivariate_stats
...
# Logger Parameters
# ======================
parser.add_argument("--name", type=str, default="multivariate")
...
wandb_logger.config.experiment = "multivariate"
...
with tqdm.tqdm(sym_pairs) as pbar:
    ...
    for i, imodel_pair in enumerate(pbar):
        ...
        multi_stats = get_multivariate_stats(
